...
class Register extends React.Component {   
    ...
    a2.className="upass"
    	let that = this
    		Fetch.Get("http://localhost:5000/login/shopdata/userinfo.php",{
    			status:"register",
    			...
    			if(json==2){
    				 let name = document.getElementById("upass")
    				 name.className=""
    			}
    			if(json!=2&&json!=0){
    				location.href="#/login"
			        ...
			        <div className="item-content">
			          <div className="item-inner">
			            ...
			            <div className="item-input">
			              <input id = "name" onBlur={this.changename.bind(this)} type="text" placeholder="Your name"/>
			            </div>
			          </div>
			        </div>
			      </li>			      
			      <li>
			        <div className="item-content">
			          <div className="item-inner">
			            ...
			            <div className="item-input">
			              <input  id = "passname" onBlur={this.changepassword.bind(this,'password')} type="password" placeholder="Password" className=""/>
			            </div>
			          </div>
			        </div>
			      </li>	   
			      <li>
			        <div className="item-content">
			          <div className="item-inner">
			            ...
			            <div className="item-input">
			              <input  type="text" placeholder="number" className=""/>
			            </div>
			          </div>
			        </div>
			      </li>
			        <li id="uname" className="uname">
			      	<div className="whitered">用户名已存在</div>
			      </li>
			      <li id="upass" className="upass">
			      	<div className="whitered" >数据错误</div>
			      </li>
			    </ul>
			  </div>
			  <div className="content-block">
			    <div className="row">
			      <a  href="#/" className="col-50 red"><div className="">取消</div></a>
			      <a onClick={this.login.bind(this)} className="col-50 green"><div className="">注册</div></a>
			    </div>
			    <a href="#/login"><div className="register">已有用户名?快点这里登录吧</div></a>
			  </div>
            </div>
        )
    }
