          ...
          <div className="login-box">
			  ...
			  <div className="logi">欢迎登录</div>
            	...
            	<ul>			     
			      ...
			      <li id="uname" className="uname">
			      	<div className="whitered">用户名不存在</div>
			      </li>
			      <li id="upass" className="upass">
			      	<div className="whitered" >用户名或密码错误</div>
			      </li>
			    </ul>
			  </div>
			  <div className="content-block">
			    <div className="row">
			      ...
			      <a onClick={this.login.bind(this)} className="col-50 green"><div className="">登录</div></a>
			    </div>
			    <a href="#/register"><div className="register">还没有用户名?点这里注册</div></a>
			  </div>
            </div>
        )
    }
